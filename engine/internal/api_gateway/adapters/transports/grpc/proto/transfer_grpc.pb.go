...
const (
	TransferService_Transfer_FullMethodName = "/transfer.v1.TransferService/Transfer"
)
...
type TransferServiceClient interface {
	Transfer(ctx context.Context, in *TransferCommand, opts ...grpc.CallOption) (*TransferResponse, error)
}
...
func (c *transferServiceClient) Transfer(ctx context.Context, in *TransferCommand, opts ...grpc.CallOption) (*TransferResponse, error) {
...
type TransferServiceServer interface {
	Transfer(context.Context, *TransferCommand) (*TransferResponse, error)
...
func (UnimplementedTransferServiceServer) Transfer(context.Context, *TransferCommand) (*TransferResponse, error) {
...
func _TransferService_Transfer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransferServiceServer).Transfer(ctx, req.(*TransferCommand))
	}
...
var TransferService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/api_gateway/adapters/transports/grpc/proto/transfer.proto",
}
